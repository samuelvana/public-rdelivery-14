...
const CustomerAccountCard = () => {
  ...
  return (
    <View style={styles.card}>
      <ArialText style={styles.subtitle}>Logged In As: Customer</ArialText>
      ...
      <ArialText style={styles.label}>Customer Email:</ArialText>
      <TextInput
        style={styles.input}
        placeholder={accountData?.customerEmail}
      ...
      />
      <ArialText style={styles.subtext}>Email used for your Customer account.</ArialText>

      <ArialText style={styles.label}>Customer Phone:</ArialText>
      <TextInput
        style={styles.input}
        placeholder={accountData?.customerPhone}
        textContentType="telephoneNumber"
        value={customerPhone}
        onChangeText={(text) => {
            // Filter input to allow only digits, plus sign, dashes, and spaces
            const sanitizedText = text.replace(/[^+\d\s-]/g, '');
            setCustomerPhone(sanitizedText);
          }}
      />
            <ArialText style={styles.subtext}>Phone number for your Customer account.</ArialText>
