...
public class AddressService {
    ...
    public Optional<Address> findByAddressDetails(String streetAddress, String city, String postalCode) {
        return addressRepository.findByStreetAddressAndCityAndPostalCode(streetAddress, city, postalCode);
    }
}